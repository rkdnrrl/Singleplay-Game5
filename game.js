(function () {
  ...
  mountTutorial({
    ...
    steps: [
      { emoji: '⚒️', title: '대장간에 오신 걸 환영해요!',
        body: '낚시 아이템을 녹여 재료를 모으고,<br>그 재료로 장비를 제작·강화하는 곳이에요.' },
      { emoji: '🔥', title: '용광로 — 아이템 녹이기',
        body: '<b>낚시에서 얻은 폐품</b>을 용광로에 넣으면<br>재료(철·구리·보석 등)가 나와요.<br>명사 등급이 높을수록 더 많이 나옵니다.' },
      { emoji: '🛠️', title: '모루 — 장비 제작',
        body: '<b>산출 재료</b>를 모루에 올려놓고 제작하면<br>무기·방어구·악세서리가 만들어져요.<br>재료 조합에 따라 능력치가 결정돼요.' },
      { emoji: '🔩', title: '모듈로 강화',
        body: '<b>모듈</b>을 장비 슬롯에 끼우면 추가 능력치를 부여할 수 있어요.<br>모듈도 재료를 모아 제작 가능!' },
      { emoji: '🔧', title: '수리',
        body: '던전에서 닳은 장비는 <b>코인을 내고 수리</b>할 수 있어요.<br>내구도 0이 되기 전에 수리하세요!' },
      { emoji: '🗡️', title: '던전 연동',
        body: '여기서 만든 장비는 <b>던전 탐험(Game7)</b>에서 장착해 사용해요.<br>좋은 장비 = 더 깊은 던전!' },
    ],
  });
})();
